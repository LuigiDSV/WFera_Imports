...
public class TelaCarrinhoCamiseta3 extends javax.swing.JFrame {
    ...
    int s = 1;
    double preco;
    double precoCamiseta3;
    double quantidadeCamoseta3;
    double total;
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta3 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta3 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta3 * quantidadeCamoseta3) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta3));
