...
public class TelaCarrinhoCamiseta6 extends javax.swing.JFrame {
    ...
    int s = 1;
    double preco;
    double precoCamiseta6;
    double quantidadeCamoseta6;
    double total;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(67, 67, 67)
                .addComponent(PainelNavBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE))
        );
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta6 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta6 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta6 * quantidadeCamoseta6) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta6));
