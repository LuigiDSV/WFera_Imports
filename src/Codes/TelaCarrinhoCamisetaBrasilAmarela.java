...
PaginaInicial PG = new PaginaInicial();
    ...
    int s = 1;
    double preco;
    double precoCamiseta10;
    double quantidadeCamoseta10;
    double total;
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta10 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta10 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta10 * quantidadeCamoseta10) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta10));
