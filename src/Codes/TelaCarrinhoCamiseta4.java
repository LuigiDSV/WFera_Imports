...
public class TelaCarrinhoCamiseta4 extends javax.swing.JFrame {
    ...
    int s = 1;
    double preco;
    double precoCamiseta4;
    double quantidadeCamoseta4;
    double total;
    ...
    private void initComponents() {
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(1300, 1050));
        ...
        jPanel1.add(PainelNavBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 870, -1, -1));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(BtFinalizarCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36))
        );

        jScrollPane1.setViewportView(jPanel2);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 1160, -1));
        ...
        jPanel1.add(PainelNavBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta4 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta4 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta4 * quantidadeCamoseta4) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta4));
