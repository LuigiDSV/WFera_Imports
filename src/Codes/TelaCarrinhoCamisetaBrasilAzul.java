...
PaginaInicial PG = new PaginaInicial();
    ...
    int s = 1;
    double preco;
    double precoCamiseta11;
    double quantidadeCamoseta11;
    double total;
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta11 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta11 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta11 * quantidadeCamoseta11) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta11));
