...
public class TelaCarrinhoCamiseta8 extends javax.swing.JFrame {
    ...
    int s = 1;
    double preco;
    double precoCamiseta8;
    double quantidadeCamoseta8;
    double total;
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta8 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta8 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta8 * quantidadeCamoseta8) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta8));
