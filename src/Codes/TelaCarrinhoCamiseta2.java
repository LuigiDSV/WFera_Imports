...
public class TelaCarrinhoCamiseta2 extends javax.swing.JFrame {
    ...
    int s = 1;
    double preco;
    double precoCamiseta2;
    double quantidadeCamoseta2;
    double total;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(23, 23, 23)
                .addComponent(PainelNavBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 1050, Short.MAX_VALUE)
        );
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta2 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta2 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta2 * quantidadeCamoseta2) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta2));
