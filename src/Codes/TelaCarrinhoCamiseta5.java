...
public class TelaCarrinhoCamiseta5 extends javax.swing.JFrame {
    ...
    int s = 1;
    double preco;
    double precoCamiseta5;
    double quantidadeCamoseta5;
    double total;
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta5 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta5 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta5 * quantidadeCamoseta5) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta5));
