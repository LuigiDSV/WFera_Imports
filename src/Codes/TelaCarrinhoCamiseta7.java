...
public class TelaCarrinhoCamiseta7 extends javax.swing.JFrame {
    ...
    int s = 1;
    double preco;
    double precoCamiseta7;
    double quantidadeCamoseta7;
    double total;
    ...
    private void BtFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarCompraActionPerformed
        MetodoPagamento();
        precoCamiseta7 = Double.parseDouble(LabelPreçonumber.getText().replace(",", "."));
        quantidadeCamoseta7 = Double.parseDouble(setQuantidadeEscolhida.getValue().toString());
        total = (precoCamiseta7 * quantidadeCamoseta7) + 15;
        ...
        try {
            ...
            docPDF.add(new Paragraph("Quantidade do produto: " + this.quantidadeCamoseta7));
