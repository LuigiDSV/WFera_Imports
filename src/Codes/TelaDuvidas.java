...
public class TelaDuvidas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Atendimento\n Para oferecer o melhor atendimento, nós temos uma equipe preparada para dar suporte, preparada para resolver todos seus problemas. Buscamos a melhor resoluções para seus\n problemas.\n\nQualidade\n Nossos produtos seguem o nosso padrão de beleza estética e, qualidade. Como vendemos produtos endereçados a clientes incríveis, nossos produtos seguem os mesmos padrões.\n\nVariedade\n  Para que nossos clientes tenham sempre uma ótima e diferente experiência, nós buscamos ter uma variedade de produtos preparados para nossos consumidores.\n\nGarantia\n Todos os produtos disponíveis tem garantia, desde o momento de compra até a entrega, não importando os dias encomendados, proporcionando uma experiência vívida do \n nosso comprometimento com o nosso cliente, confia.\n\nPromoções\n  Os nossos clientes cadastrados recebem notificações de promoções e descontos fornecidos pela WFera.\n\nInformações de envio\n  Nós entregamos por todo o Brasil de forma rápida e segura, utilizamos nosso serviços de entregas e empresas de entregas parceiras, para garantir a chegada do produto.\n\n Como é entregue o produto\n  O produto começa a ser direcionado ao local, no momento da compra, é feito a embalagem do produto e todos os processos de segurança. Logo após, é direcionado a equipe de\n rastreamento, visto o local, é endereçado ao carro/caminhão. E, é entregue o nosso produto ao cliente.\n");
